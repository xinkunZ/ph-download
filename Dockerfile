...
CMD [ "java", "-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:15005","-Dhttps.proxyHost=127.0.0.1","-Dhttps.proxyPort=17890", "-Dhttp.proxyHost=127.0.0.1", "-Dhttp.proxyPort=17890", "-jar", "/opt/docker/ph-dowload.jar" ]
